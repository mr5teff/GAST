...
public class Test_JDBCBestellungDAO {
	...
	public void setUpBeforeClass() throws Exception {
		...
		p1 = new Bestellung(-1,1, p1_produkt.getId(), p1_produkt.getName(), p1_produkt.getPreis(), null, "bestellt",false, new Date(), null,0);
		p2 = new Bestellung(-1,1, p1_produkt.getId(), p1_produkt.getName(),  p1_produkt.getPreis(), p1_rechnung.getId(), "bezahlt", false,new Date(), null,0);
		p3 = new Bestellung(-1,1, p2_produkt.getId(), p2_produkt.getName(),  p2_produkt.getPreis(), 0, "bezahlt", false,new Date(), null,0);
		
		p4 = new Bestellung(-1,-200, p1_produkt.getId(), p1_produkt.getName(),  p1_produkt.getPreis(), null, "bestellt",false, new Date(), null,0);
		p5 = new Bestellung(-1,-300, p1_produkt.getId(), p1_produkt.getName(),  p1_produkt.getPreis(), null, "wirdGekocht",false, new Date(), null,0);
		p6 = new Bestellung(-1,-400, p2_produkt.getId(), p2_produkt.getName(),  p2_produkt.getPreis(), null, "fertigGekocht", false,new Date(), null,0);
		p7 = new Bestellung(-1,-500, p2_produkt.getId(), p2_produkt.getName(),  p2_produkt.getPreis(), null, "geliefert", false,new Date(), null,0);
		...
		p8 = new Bestellung(-1,1, p2_produkt.getId(), p2_produkt.getName() ,  p2_produkt.getPreis(), null, "bestellt", false,new Date(), null,0);
		p9 = new Bestellung(-1,1, p2_produkt.getId(), p2_produkt.getName(),  p2_produkt.getPreis(), p2_rechnung.getId(), "bezahlt", false,new Date(), null,0);
